...
test("admin editor exposes builds and separate KDA without raw JSON", () => {
  ...
  added.player.matches[0].rankingFarm = "30";
  added.player.matches[0].rankingHealing = "7964";
  added.player.matches[0].lastHits = "34";
  added.player.matches[0].healing = "6077";
  added.player.matches[0].board[0].rankingFarm = "30";
  added.player.matches[0].board[0].rankingHealing = "7964";
  added.player.matches[0].board[0].lastHits = "34";
  ui.tab = "matches";
  ...
  assert.match(matches, /value="30"[^>]*data-field="rankingFarm"/);
  assert.match(matches, /value="7964"[^>]*data-field="rankingHealing"/);
  assert.match(matches, /value="34"[^>]*data-field="lastHits"/);
  assert.doesNotMatch(matches, /value="30"[^>]*data-field="lastHits"/);
  assert.doesNotMatch(matches, /value="30"[^>]*data-field="healing"/);
  assert.ok(matches.indexOf('data-field="rankingFarm"') < matches.indexOf('data-field="healing"'));
