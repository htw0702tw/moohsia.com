...
const zh = {
  ...
  items: {
    kicker: "08 — ITEMS",
    title: "裝備",
    lead: "名稱、圖示與說明來自 Garena 傳說對決公開裝備列表。",
    emptyTitle: "裝備目錄暫時讀不到",
    emptyBody: "請稍後再看。",
    source: "資料來源：Garena 傳說對決官方裝備列表",
    all: "全部",
    count: "件裝備",
  },
  modes: {
...
const en = {
  ...
  items: {
    kicker: "08 — ITEMS",
    title: "Items",
    lead: "Names, icons, and descriptions come from the public Garena equipment list.",
    emptyTitle: "Item catalog unavailable",
    emptyBody: "Try again in a moment.",
    source: "Source: the official Garena equipment list",
    all: "All",
    count: "items",
  },
  modes: {
