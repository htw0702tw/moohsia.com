...
const zh = {
  ...
  player: {
    ...
    farmUnverified: "AOVRanking 的補兵、控場（秒）、治療、塔傷不是遊戲內補刀數、控制效果、治療量、對塔傷害。對過截圖後才顯示。",
...
const en = {
  ...
  player: {
    ...
    farmUnverified: "AOVRanking creep, CC seconds, healing, and tower are not in-game last hits, CC, healing, or tower damage. Those labels appear after the match is checked.",
