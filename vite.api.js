...
function envFromLocal() {
  ...
  return {
    ...
    NOTION_TOKEN: read("NOTION_TOKEN"),
    NOTION_WEBHOOK_SECRET: read("NOTION_WEBHOOK_SECRET"),
    NOTION_ROSTER_DB: read("NOTION_ROSTER_DB"),
    NOTION_NEWS_DB: read("NOTION_NEWS_DB"),
    NOTION_COPY_DB: read("NOTION_COPY_DB"),
